...
| vLLM                 | inference            | <p>高性能高吞吐推理服务框架， </p><ul><li><strong>高性能推理</strong>：基于 PagedAttention 技术，优化显存利用率，支持每秒处理 <strong>20倍以上</strong> 的请求量（相比原生Hugging Face Transformers）。</li><li><strong>易用性</strong>：与Hugging Face模型兼容，仅需少量代码修改即可部署。</li><li><strong>支持功能</strong>：流式输出、多GPU并行、量化（AWQ/GPTQ）、OpenAI API兼容接口等。</li></ul> |
|                      |                      |                                                                                                                                                                                                                                                                                                    |
| RAG 部分               |                      |                                                                                                                                                                                                                                                                                                    |
